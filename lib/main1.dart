...
import 'package:step_counter1/snake.dart';

class UsingSensor extends StatefulWidget {
  const UsingSensor({super.key});

  @override
  State<UsingSensor> createState() => _UsingSensorState();
}

class _UsingSensorState extends State<UsingSensor> {
